      ...
      {isExpanded && (
        <div className="px-4 pb-4 pt-2 border-t border-gray-100">
          <textarea
            ...
            className="w-full min-h-[120px] p-3 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-y"
            onClick={(e) => e.stopPropagation()}
          />
        </div>
      )}
