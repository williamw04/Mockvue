// Cheat sheet content — maps 1:1 to the user's 10-section template.
// Populated for Alex Moreno → Northwind Media.
...
const MV_SHEET = {
  ...
  snapshot: {
    ...
    values: ['Radical Candor', 'Context not Control', 'Highly Aligned · Loosely Coupled', 'Bias for Impact'],
    news: [
  ...
  role: {
    ...
    skills: ['Video/streaming domain depth', 'Cross-functional leadership', 'Experimentation & metrics rigor', 'Technical fluency w/ infra teams'],
    success: {
    ...
    signals: [
      { s: 'Video infrastructure domain experience', evidence: 'JD mentions "streaming infra" 3x', p: 'High' },
      { s: 'Shipped launches with measurable KPIs',  evidence: 'JD asks for "numerate PMs"',     p: 'High' },
      { s: 'Comfort operating without tight guidance', evidence: '"Context not Control" value',  p: 'Medium' },
  ...
  stories: [
    {
      ...
      followups: ['What would you do differently? — start infra-team syncs earlier.', 'Deep dive: the one week we slipped on TV.'],
    },
    {
  ...
  // § 4
  questionMap: [
    { q: 'Tell me about a time you disagreed with your manager.', primary: 'VP disagreement on checkout', backup: 'Pricing experiment that failed' },
    { q: 'Walk me through a cross-functional launch.',             primary: 'Helix playback migration',       backup: 'Vendor migration' },
    { q: 'A time you gave up control to empower a team.',          primary: 'Q3 roadmap autonomy',             backup: 'Vendor migration' },
    { q: 'Tell me about a launch that failed.',                    primary: 'Pricing experiment that failed',  backup: null },
    { q: 'How do you know your customers?',                        primary: 'Onboarding redesign',             backup: null },
    { q: 'Biggest technical decision you\'ve owned?',              primary: 'Helix playback migration',        backup: null },
  ],
  // § 5
  alignment: {
    valueToStory: [
  ...
  strengthsWeaknesses: {
    ...
    weaknesses: [
      { w: 'Under-indexed on live-events experience', mit: 'Read Stagebox acquisition memo; prepped 2 hypothetical tests to propose.' },
      { w: 'Can be slow on written updates',          mit: 'For the last two launches, sent a Monday 3-line status. Framed as a habit, not a one-off.' },
    ],
  },
  // § 7
  talkingPoints: {
    ...
    narrative: 'Started on ads infra at Kestrel, moved to playback at Helix in 2021, ran a four-PM team for the last 18 months. Through-line: I like product problems where the infra matters, and I like teams small enough that PMs still write code-adjacent specs.',
    whyCompany: 'Northwind made the bet I would have made — quality over tiers. The Stagebox acquisition tells me Playback gets serious live-events investment, and that\'s a rare domain problem I want to own.',
    whyRole: 'Three platforms, a quality-first mandate, and a manager (Rita) who has shipped what I want to learn. This role is where my Helix learnings compound.',
  },
  // § 8
  ...
  logistics: {
    ...
    interviewers: [
      { name: 'Rita Chen',    role: 'Director of Product, Playback (HM)', notes: 'Behavioral-heavy. Known for the "disagree w/ manager" question.' },
      { name: 'Marcus Vohra', role: 'Dir Engineering, Playback',          notes: 'Will probe technical trade-offs. Likes numbers.' },
      { name: 'Priya Shah',   role: 'Sr PM, Playback',                     notes: 'Peer check — cultural fit + collab style.' },
      { name: 'TBD',          role: 'Product case interviewer',            notes: '20-min case. Likely playback-related.' },
    ],
  ...
  reflection: {
    ...
    struggled: '—',
    toAdd: '—',
    locked: true, // only fillable after the interview
  },
};

// Ready-percent by section (computed once, used in nav)
const MV_SHEET_PROGRESS = [
...
Object.assign(window, { MV_SHEET, MV_SHEET_PROGRESS });
