...
export default function StoriesPage() {
  ...
  return (
    <div className="flex h-screen bg-gray-100 text-gray-900">
      ...
      {/* Stories List */}
      <aside className="w-80 border-r pt-20 overflow-y-auto bg-surface border-gray-200">
                ...
                <h2 className="text-3xl font-bold">
                  {isEditing ? (
                    <input
                      ...
                      className="w-full px-4 py-2 rounded-lg border bg-surface border-gray-300 text-gray-900"
                    />
                  ) : (
                    selectedStory.title
                  )}
                ...
                <div>
                  ...
                  {isEditing ? (
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-3 rounded-lg border bg-surface border-gray-300 text-gray-900"
                    />
                  ) : (
              ...
              {isEditing && (
                <div className="flex gap-3 mt-8">
                  ...
                  <button
                    ...
                    className="px-6 py-3 rounded-lg font-semibold transition-colors bg-gray-100 hover:bg-gray-200"
                  >
                    Cancel
                  </button>
                </div>
