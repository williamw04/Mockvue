      ...
      <div className="px-4 py-3 border-b border-rule flex-shrink-0">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[10px] text-accent-hi tracking-widest uppercase">
              AGENT
            </span>
          </div>
        </div>
        ...
        >
          <span className="text-sm font-medium truncate">
            {activeChat?.name || 'General Review'}
          </span>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 text-sm text-ink-2">
                ...
                <div className="space-y-2">
                  <p className="text-[10px] text-ink-3 font-mono tracking-wide uppercase">
                    TRY ASKING
                  </p>
