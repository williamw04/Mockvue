...
function Chip({
  ...
  return (
    <span
      className={`${bg} ${color} font-mono text-[9px] px-1.5 py-0.5 tracking-wide whitespace-nowrap`}
    >
      {label}
    </span>
  );
...
export function BulletDiffEditor({
  ...
  if (!section) {
    return <div className="text-center py-20 text-ink-3">Select a section to view bullets</div>;
  }
  ...
  return (
    <div>
      ...
      <div className="mb-5">
        ...
        <h2 className="font-serif text-2xl font-medium tracking-tight text-ink">{section.title}</h2>
      </div>

      {/* Column Headers */}
      <div className="grid grid-cols-2 gap-4 mb-3">
        <div className="font-mono text-[10px] tracking-widest text-ink-3 uppercase">ORIGINAL</div>
                  ...
                  <div className="border-t border-rule px-4 py-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          onSetBulletState(bulletId, 'accepted');
                        }}
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          onSetBulletState(bulletId, 'rejected');
                        }}
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          onSetBulletState(bulletId, 'pending');
                        }}
