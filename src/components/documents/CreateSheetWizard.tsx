        ...
        <div className="w-full max-w-[600px] px-8">
          ...
          {step === 1 && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-6">
                <div>
                  <label className="block font-mono text-[11px] text-ink-3 tracking-wide uppercase mb-2">Company Name</label>
                  <input 
                    type="text" 
                    value={company}
                ...
                <div>
                  <label className="block font-mono text-[11px] text-ink-3 tracking-wide uppercase mb-2">Role Title</label>
                  <input 
                    type="text" 
                    value={role}
          ...
          {step === 2 && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-6">
                <div>
                  <label className="block font-mono text-[11px] text-ink-3 tracking-wide uppercase mb-2">Job Description</label>
                  <textarea 
                    value={jd}
                ...
                <div>
                  <label className="block font-mono text-[11px] text-ink-3 tracking-wide uppercase mb-2">Baseline Resume</label>
                  <select 
                    value={resume}
          ...
          {step === 3 && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <p className="text-[14px] text-ink-2 mb-6 leading-relaxed">
                Add any specific context to help the AI tailor your cheat sheet. Who are you meeting with? What are you worried about?
              </p>
              <div className="space-y-6">
                <div>
                  <label className="block font-mono text-[11px] text-ink-3 tracking-wide uppercase mb-2">Logistics & Interviewers</label>
                  <textarea 
                    value={logistics}
                ...
                <div>
                  <label className="block font-mono text-[11px] text-ink-3 tracking-wide uppercase mb-2">Specific Concerns or Focus Areas</label>
                  <textarea 
                    value={concerns}
